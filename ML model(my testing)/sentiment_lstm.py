...
MAX_LEN = 250
EMBEDDING_DIM = 100
MODEL_PATH = r'C:\Users\hp\OneDrive\Desktop\ml model\sentiment_analysis_newonelstm.keras'
TOKENIZER_PATH = r'C:\Users\hp\OneDrive\Desktop\ml model\tokenizerlstm.pickle'
...
# Train the model
model.fit(train_data, train_labels, epochs=11 , batch_size=128, validation_split=0.2)
